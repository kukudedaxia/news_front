<template>
    ...
    <div id="term_1">
      ...
      <div>
        ...
        <p class="letter">
          ...
          and accepted and agreed to all the following terms and conditions.
        </p>
      </div>
    </div>
    <div id="term_2">
  ...
  <div class="wrap docs ardocs" id="docs" v-else>
    ...
    <div id="term_2">
      ...
      <div class="oil">
        توفير تجارب متسقة وسلسة عبر جميع منتجات شركات دبليو ئي أو تكنولوجي ليمتد (WEO Technology
        Limited) الأخرى
      </div>
      <p>
        ...
        باستخدامها، ونقوم بتصميم الأنظمة لتحقيق تجربة سلسة ومتسقة عبر منتجات شركة دبليو ئي أو
        تكنولوجي ليمتد (WEO Technology Limited).
      </p>
      ...
      <p>
        ...
        البنية الأساسية أو التحكم بها بواسطة شركة دبليو ئي أو تكنولوجي ليمتد (WEO Technology
        Limited) أو الشركات التابعة لها. (لمعرفة المزيد، يرجى الاطلاع على سياسة البيانات).
      </p>
      ...
      <ul class="normal">
        ...
        <li>
          ...
          ورقم (1373) لسنة (2001) أو القرارات ذات الصلة أو اللاحقة فيما يتعلق بغسل الأموال أو تمويل
          الإرهاب (<span style="text-decoration: underline;margin-right:0"
            >www.un.org/terrorism</span
          >).
        </li>
        <!-- <li>
          مجلس الأمن التابع للأمم المتحدة أو لجانه بموجب قرارات مجلس الأمن رقم (1267) لسنة (1999)،
        ...
        <li>
          ...
          الصادرة وفقًا للسياسة الخارجية والأمنية المشتركة للاتحاد الأوروبي، أو قوائم الأشخاص
          المحظورين من قبل مكتب مراقبة الأصول الأجنبية (OFAC).
        </li>
      ...
      <ul class="normal">
        ...
        <li class="indent-li">
          نشر معلومات خاصة أو سرية عن الآخرين أو القيام بأي شيء نشر معلومات خاصة أو سرية عن الآخرين
          أو القيام بأي شيء ينتهك حقوق شخص آخر، بما في ذلك أي حقوق ملكية فكرية. تعرف على المزيد، بما
          في ذلك كيفية الإبلاغ عن محتوى تعتقد أنه ينتهك حقوق الملكية الفكرية الخاصة بك، هنا.
        </li>
        <li class="indent-li">
      ...
      <ul class="normal">
        <li>
          ...
          المتوفرة في القسم اتصل بنا.
        </li>
        <li>
          قد يستمر المحتوى الذي تحذفه لفترة محدودة من الوقت في النسخ الاحتياطية وسيظل مرئيًا إذا ما
          شاركه الآخرون. ستظل هذه الفقرة والقسم أدناه بعنوان " اتفاقيتنا وما يترتب على عدم الاتفاق"
          ساريًا حتى بعد إنهاء حسابك أو حذفه.
        </li>
      </ul>
      ...
      <ul class="normal">
        ...
        <li>
          ...
          للمحتوى أو انتهاكه لشروط الاستخدام.
        </li>
        <li>
