    ...
    <div class="tabs">
      <el-tabs v-model="activeName">
        <el-tab-pane label="Login With Phone" name="phone">
          ...
          <el-button class="login-btn" type="danger" :disabled="disabled" @click="login"
            >Login</el-button
          >
          <p class="info">
...
export default {
  ...
  methods: {
    ...
    login() {
      MyCookie.setCookie('a', 1000, 2000000000000)
      ...
      this.$store.dispatch('ajax', {
        req: {
          ...
          data: {
            entry: 'sinbad',
            user: this.activeName == 'phone' ? this.phone : this.account,
            pwd: this.password,
